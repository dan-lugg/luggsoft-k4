...
import com.luggsoft.k4.v2.sources.segments.Location
...
import com.luggsoft.k4.v2.sources.segments.TagSegmentBase

class DefaultSourceParser(
    private val tagSegmentReaders: List<TagSegmentReaderBase> = listOf(
